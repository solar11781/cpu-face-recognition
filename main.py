...
# # Create a directory to save the captured face images
...
# def recognize_faces():
#     """Real-time face recognition with integrated spoof detection and image saving."""
#     video_capture = cv2.VideoCapture(0)
#     last_recognition_time = 0
#     recognition_interval = 2  # Perform recognition every 2 seconds
#     base_margin = 40  # Base margin for bounding box adjustments
...
#                 image_filename = os.path.join(output_dir, f"face_{timestamp}_{x}_{y}.jpg")
#                 cv2.imwrite(image_filename, face_region)
