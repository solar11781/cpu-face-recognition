...
import cv2
import time
from process_frame import load_gfpgan_model, enhance_frame_with_gfpgan
from face_detect import detect_faces, draw_bounding_box
from face_rec import load_known_faces, recognize_face
...
def recognize_faces():
    ...
    while True:
        ...
        if current_time - last_recognition_time >= 10:
            ...
            # Enhance the current frame using GFPGAN
            enhanced_frame = enhance_frame_with_gfpgan(frame, gfpgan_model)
